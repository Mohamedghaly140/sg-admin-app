...
function Button({
  ...
  return (
    <ButtonPrimitive
      ...
      render={render}
      // Base UI defaults `nativeButton` to true. When rendered as a custom
      // element via `render` (e.g. a Next.js <Link>), it's not a native
      // <button>, so default to false to keep correct button semantics.

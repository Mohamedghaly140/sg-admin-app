...
| Phase | Scope | Status |
|---|---|---|
| [1 — Foundation](./phase-1-foundation.md) | Providers, auth, API client, shell, primitives | ✅ done |
| [2 — Categories & Uploads](./phase-2-categories-and-uploads.md) | First CRUD loop + `ImageUploader` | ✅ done |
...
| [8 — Hardening](./phase-8-hardening.md) | States, a11y, responsive, QA sweep | 🟨 in progress |
